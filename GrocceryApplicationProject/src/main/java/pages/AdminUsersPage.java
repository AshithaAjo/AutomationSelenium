...
PageUtility page= new PageUtility();
	...
	@FindBy(xpath="//button[@name='Create']") WebElement saveuserbutton;
	
	@FindBy(xpath="//a[@class='btn btn-rounded btn-primary']") WebElement usersearchbutton;
	@FindBy(xpath="//input[@id='un']") WebElement usernametextbox;
	@FindBy(xpath="//select[@id='ut']") WebElement usertype;
	@FindBy(xpath="//button[@class='btn btn-block-sm btn-danger' and @name='Search']") WebElement searchuserbutton;
	
	@FindBy(xpath="//a[@class='btn btn-rounded btn-warning']") WebElement resetuser;
	
	@FindBy(xpath="//h1[@class='m-0 text-dark']") WebElement adminuserpage;
