...
public class AdminUsersTest extends TestNGBase {
	...
	public void verifyWhetherUserIsAbletoAddNewUser() throws IOException {
		...
		adminuser = homepage.adminClickOnMoreInfo();
		...
		adminuser.enterUsernameOnUsernameTextBox(usernamevalue1).enterPasswordOnPasswordTextBox(passwordvalue1)
				.selectUserTypeDropDown().ClickOnSaveUserButton();

		boolean adminuserdisplaypage = adminuser.isAdminUserPageDisplayed();
	...
	public void verifyWhetherUserIsAbletoSearchAddedUser() throws IOException {
		...
		// AdminUsersPage admin=new AdminUsersPage(driver);
		adminuser.clickOnSearchButton().enterUsername(usernamevalue1).selectUserType().clickOnSearchUser();
	...
	public void verifyWhetherUserIsAbletoResetUser() throws IOException {
		...
		// AdminUsersPage admin=new AdminUsersPage(driver);
		adminuser.clickOnReserUserButton();
